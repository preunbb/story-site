  ...
  products: [
    ...
    },
    {
      ...
      description:
        ...
        "diagnoses. For recrational usage instead of sampling, simply detach the removable vial.",
    },
    {
      id: "bleach-wipes",
      category: "medical",
    ...
    },
    {
      ...
      tagline: "It learns what he's trying to hide.",
      description:
    ...
    },
    {
      ...
      images: [
        {
          path: "../assets/scenes/andrea_and_lucas/overeasy_ball_cuff_device_v2.png",
          caption: "Ball Cuff™ — deep-profile ring",
        },
        {
          path: "../assets/scenes/andrea_and_lucas/lucas_hyperspermia_scrotum_textbook_diagram_v1.png",
          caption:
            "Sizing reference — hyperactive testicular disorder (hyperspermia)",
        },
      ],
    ...
    },
    {
      ...
      description:
        ...
        "built-in AI greets women with a discreet vulva scanner. Male entrants will be audited appropriately," +
        "Whether Luna can identify him with a single squeeze, or if she needs to dive in deep and extract some of his" +
        "sperm cells to verify his identity, she'll guarantee he is who he says he is.",
      features: [
        "Articulated arm allows verification on groins of " +
