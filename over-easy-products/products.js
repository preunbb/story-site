  ...
  products: [
    ...
    },
    {
      ...
      description:
        ...
        "cross-sections, volume benchmarks, and cord stress tolerances. Standard " +
        "issue in Over Easy partner clinics and recommended wall art for any woman " +
        "dating a man who insists he has this mythical condition.",
    },
    {
      id: "biopsy-gun",
      category: "medical",
    ...
    },
    {
      ...
      description:
        ...
        "and answers it — expanding, contracting, thrusting, and finding his sensitive little love button " +
        "whether he cooperates or not. The harder he tries to push it out, the harder " +
        "it pushes in. Trained for hands-free control while you watch him squirm and leak.",
      features: [
    ...
    },
    {
      ...
      description:
        ...
        "audited appropriately,Whether Luna can identify him with a single squeeze, or " +
        "if she needs to dive in deep and extract some of hissperm cells to verify his " +
        "identity, she'll guarantee he is who he says he is.",
      features: [
