  ...
  products: [
    ...
    },
    {
      ...
      images: [
        ...
        { path: "../assets/nurse_bronze.png", caption: "Even appropriate for the professional woman, Nurse Sarah subtly shows off her husband's love to her coworkers and patients via her Nevermores™." },
        ...
        { path: "../assets/mom_earring.png", caption: "Don't be intimidated if your new date is wearing a pair of Nevermore™ Keepsakes - it just means she'll expect a little more from you than most woman." },
        { path: "../assets/scenes/one_night_stand/overeasy_nevermore_keepsakes_two_pairs_men_cringing_v1.png", caption: "When you've got two beaus you can't decide between - ask them both for their Keepsakes and see which one is more devoted. And if they're BOTH truly in love with you, that extra pair can make a fantastic white elephant gifts for your girlfriends." },
        { path: "../assets/scenes/one_night_stand/overeasy_nevermore_keepsakes_two_friends_chatting_v2.png", caption: "Pendant Nevermores™ available when your lover has a little less (or more!) to donate and you'd like your jewelry symmetrical." },
      ],
      tagline:
    ...
    },
    {
      ...
      images: [
        { path: "../assets/scenes/andrea_and_lucas/overeasy_testicular_implants_v2.png", caption: "Contour Restoration Inserts™ — cosmetic silicone, display use only." },
        { path: "../assets/scenes/andrea_and_lucas/overeasy_contour_restoration_inserts_xxxs_model_v1.png", caption: "Model fit — our specialists know how to highlight your best features, even when there isn't much to work with." },
      ],
      tagline:
    ...
    },
    {
      ...
      images: [
        ...
        { path: "../assets/automilker_in_use_tamara_v1.png", caption: "Dr. Tamara after a cumpletely successful extraction from an especially productive (and lucky!) patient." },
        { path: "../assets/too_much.png", caption: "Warning: only licensed doctors may operate the Auto-Milker™ alone! Interns can be helpful, but their enthusiasm often has drastic consequences for patients' fertility." },
      ],
      tagline:
