  ...
  products: [
    ...
    },
    {
      ...
      description:
        ...
        "it's now safe for home and medical use!scrotum pouch, and let " +
        "electrostimulation plus precision compression wring out every last drop — " +
        "usually in two or three minutes, even from inmates on a once-a-month " +
        "allowance. Pleasure not guaranteed.",
      features: [
