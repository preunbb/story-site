  ...
  products: [
    {
      ...
      name: "Ball Killers™",
      model: "OET-BK-1",
      image: "assets/scenes/andrea_and_lucas/overeasy_ball_killers_heels_v1.png",
      images: [
        ...
        { path: "assets/scenes/overeasy_catalog/overeasy_ball_killers_dept_store_demo_caption_v1.png", caption: "Tungsten toes for when sorry isn't enough — shattered testicles, zero regrets." },
      ],
      tagline: "Fashionable. Functional. Pointed.",
      description: "Self-defense you can wear to dinner. Glossy patent pumps with tungsten-tipped points at heel and toe — as sexy on the dance floor as they are useful when someone needs a very direct lesson in boundaries. Be sure to clean thoroughly between uses!",
    },
    {
      id: "eunuchcorn-denim",
      category: "fashion",
      ...
      description: "Finally — denim that fits what's left. EunuchCorn jeans and shorts feature an ultra-high seam and extra-tight flat front: no embarrassing loose crotch, no pointless zipper bulge, just the confident silhouette of a man who's already said goodbye to his legacy.",
      features: [
    ...
    },
    {
      ...
      images: [
        ...
        { path: "assets/mom_earring.png", caption: "After you break up with him, you can wear the pair of Nevermores™ your ex gave you to first dates so men know you know your worth." },
      ...
      description: "The problem with those beautiful nights of passion is that they don't last. Over Easy's bronzing services give you a permanent reminder of that most memorable moment in the life of your husband, partner, or one night stand.",
    },
    {
      ...
      model: "CBT-PND-1",
      image: "assets/scenes/andrea_and_lucas/church_broken_tree_pendant_product_v1.png",
      images: [
      ...
      description: "For the spiritual girl who wants a reminder of the Goddess's promise - that what hangs between his legs was never meant to last.",
    },
    {
      id: "cherry-pop-album",
      category: "media",
      ...
      model: "CP-PDPD-001",
      image: "assets/scenes/andrea_and_lucas/cherry_pop_album_cover_product_v1.png",
      images: [
      ...
      description: "The latest Cherry Pop! release — Plum Dumb & Permanently Done, recorded live from their show at Brokeberry Mall. With microphones beneath every panel of the dance floor, every pop and squick from the band's most legendary mush pit is captured in perfect audio fidelity. Available on CD and vinyl.",
      setlist: [
        "Crushed to Bits",
        "The Leafless Tree",
        "Shredded Seed",
    ...
    },
    {
      ...
      model: "OET-GIP-24",
      image: "assets/scenes/andrea_and_lucas/overeasy_comparative_gonadal_integrity_poster_realistic_v1.png",
      images: [
    ...
    },
    {
      ...
      model: "OET-HSD-24",
      image: "assets/scenes/andrea_and_lucas/lucas_hyperspermia_scrotum_textbook_diagram_v2.png",
      description: "Vintage textbook plate illustrating the effects of 'hypersecretory disorder', an antiquated name for what doctors now call 'hyperactive testicular disorder'. A great gift for the man who insists he has this mythical condition .",
    },
    {
      id: "biopsy-gun",
      category: "medical",
      ...
      model: "OET-TBG-1",
      image: "assets/scenes/andrea_and_lucas/testicular_biopsy_gun_device_v2.png",
      description: "Hospital-grade instrument for removing testicular tissue samples for analysis. Extra thick collection needle ensures adequate retrieval for even the toughest diagnoses. For recrational usage instead of sampling, simply detach the removable vial.",
    },
    {
      id: "bleach-wipes",
      category: "medical",
      ...
      description: "Patented bleach wipes strong enough to neutralize every germ and ambitious future heir they touch, yet gentle enough for your most delicate bits. Essential for cleaning up any serious breeding hazard after a night of fun with a boy.",
      features: [
    ...
    },
    {
      ...
      description: "For men with only one remaining testicle, standard cups leave too much room — your lone survivor bounces, pinches, and slides into the gap. OneNut© cups are molded just for you, to protect what little you have left.",
      sizeOptions: [
    ...
    },
    {
      ...
      model: "OET-TI-2",
      image: "assets/scenes/andrea_and_lucas/overeasy_testicular_implants_v2.png",
      images: [
      ...
      description: "Lost something precious? These cosmetic replacements restore the outline — and absolutely nothing else. No hormones. No fertility. No sensation. Just a convincingly full profile for the man who wants to pretend he's still packing heat.",
      sizeOptions: [
    ...
    },
    {
      ...
      description: "The first personal taser engineered to fit exactly where he's most vulnerable. Angled prods and a snub-nose body slide between the legs; three power settings let you choose how permanently you remove him from the gene pool — from a month-long pause to a forever farewell.",
      features: [
    ...
    },
    {
      ...
      description: "Brushed stainless pocket popper for the self-defense enthusiast on the go. Dismantle his family tree slowly and intentionally with the pointed end, or give him a quick ejection from the genepool with its pneumatic bolt. Keychain included.",
      features: [
    ...
    },
    {
      ...
      name: "The BellRinger™",
      model: "OET-BR-1",
      image: "assets/scenes/andrea_and_lucas/overeasy_bell_ringer_device_v1.png",
      images: [
      ...
      description: "Sleek palm-sized orb that emits focused subsonic pulses. With vibration frequency precisely tuned to the exact resonant frequency of testicular matter, one BellRinger can keep a whole room of men on their knees until deactivated. Useful for defending yourself from multiple male attackers at once, getting through long lines quickly, or just clearing some personal space for yourself on a crowded subway.",
      features: [
    ...
    },
    {
      ...
      description: "Matte-black precision clamp with polished steel disc pads and app-connected compression control. Perfect for extracting information and confessions from disobedient men.",
      sizeOptions: [
    ...
    },
    {
      ...
      description: "With its dual-ended piezoreactive automechanical architecture, this strap-on lets you feel everything he feels when you're inside him. Osmium filled false balls hang below to pound his sensitive manhood to mush as you rearrange his guts, and the internal g-spot stimulator keeps you locked in and cumming through the whole ride instead of waiting to sit on his face afterwards.",
      features: [
    ...
    },
    {
      ...
      model: "OET-RPP-1",
      image: "assets/scenes/andrea_and_lucas/overeasy_reactive_prostate_plug_device_v1.png",
      tagline: "Break him. Plug him. Make him cum the hard way.",
      description: "Not your normal plug. Over Easy's reactive architecture reads his resistance and answers it — expanding, contracting, thrusting, and finding his sensitive little love button whether he cooperates or not. The harder he tries to push it out, the harder it pushes in. Trained for hands-free control while you watch him squirm and leak.",
      features: [
    ...
    },
    {
      ...
      model: "OET-FSM-1",
      image: "assets/scenes/andrea_and_lucas/overeasy_fail_safe_cocksleeve_device_v5.png",
      tagline: "A lesson he won't forget.",
      description: "Tired of your pathetic prejacing sub staining your nice boots? Want to train him to actually prioritize your pleasure? With the Last Shot™ Disciplinary Milker / Elastrator, you can guarantee he'll either learn to last, or cum his last. The default disciplinary duration is one hour (the average real normal man's time to ejaculation); to configure longer durations, consult the manual.",
    },
    {
      id: "ball-cuff",
      category: "sex-toys",
      ...
      description: "Thick rubber ring made of ultra-dense silicone composite, designed to keep him packaged up nice and tight for your pleasure.",
    },
    {
      id: "ball-anvil",
      category: "sex-toys",
      ...
      description: "For the woman who wants to forge a new connection with her man and hammer home who's in charge. Our commercial Ball Anvil™ upgrades the popular open-source design into injection-molded black plastic with twin oval wells — sized so his fragile lumps of ore have enough room to spread flat between your cheeks, but are still kept in place so he can't escape the points beneath.",
    },
    {
      ...
      model: "OET-LIA-1",
      image: "assets/scenes/andrea_and_lucas/overeasy_luna_identity_arm_scanner_mode_v2.png",
      images: [
      ...
      description: "Wall-mounted access control for spaces that cannot afford ambiguity. Luna's built-in AI greets women with a discreet vulva scanner. Male entrants will be audited appropriately. No matter whether Luna can tell his identity with a single squeeze, or requires a more invasive internal testicular audit, she'll guarantee he is who he says he is.",
      features: [
    ...
    },
    {
      ...
      description: "Besides pressing garlic, this handy press is great whenever you need to extrude something in the kitchen into a uniform mush.",
    },
    {
      id: "microplane",
      category: "kitchen-gadgets",
      ...
      description: "With its ultra-fine grit and carbon-steel construction, this microplane can turn cheese, vegetables, or even meat into the finest of shavings.",
    },
    {
      id: "dual-egg-slicer",
      category: "kitchen-gadgets",
      ...
      description: "Great for egg salad. Double wide design allows you to slice those eggs twice as fast!",
    },
    {
      id: "olive-pitter",
      category: "kitchen-gadgets",
      ...
      description: "Instantly pops the hard center out of cherries, olives, or even plums.",
    },
    {
      id: "meat-tenderizer",
      category: "kitchen-gadgets",
    ...
    },
    {
      ...
      description: "Simply half your desired fruit and use our patented reamer to extract every last drop of juice.",
    },
    {
    ...
    },
    {
      ...
      model: "OET-ST-SD-1",
      image: "assets/scenes/overeasy_catalog/overeasy_self_defense_skill_class_v1.png",
      tagline: "Get your money's worth.",
      description: "Over Easy's certified self-defense curriculum teaches you to protect yourself — and make every lesson count when someone needs a very direct reminder of where he's vulnerable. Reflex drills, boundary-setting techniques, and below-the-belt precision that leaves a permanent impression.",
      features: [
    ...
    },
    {
      ...
      model: "OET-ST-MC-1",
      image: "assets/scenes/overeasy_catalog/overeasy_michelin_star_cooking_class_v1.png",
      tagline: "Plate him like a professional.",
      description: "Elevate your kitchen game with techniques from Michelin-trained chefs — knife skills, precise trimming, and how to reduce stubborn ingredients to their essential parts. Perfect for the hostess who wants dinner to end with nothing left on his plate.",
      features: [
