# Nash Equilibrium — testicle stats

## Male testicle status

| Male character | Left testicle | Right testicle |
| --- | --- | --- |
| **Subject 1** (triplet) | **Popped** — Cathy thumb horizontal split (*squelch*). | **Popped** — simultaneous thumb crush with Subject 2's last nut. |
