# School Bully — testicle stats

## Male testicle status

| Male character | Left testicle | Right testicle |
| --- | --- | --- |
| **Robert** | **Removed** — Ch.2 popped by Monique; Ch.3 orchiectomy (Maria). | **Popped / evacuated** — Ch.6 Monique heel *squelch* liquifies; hospital vacuum procedure (Epilogue). **Eunuch** with frozen sample later destroyed by Monique. |
...
| **3 — Maria (clinic)** | 0 | 0 |
| **4 — Malcolm (yardwork)** | 1 | 0 |
| **5 — Monique II (bus)** | 0 | 3 |
| **6 — Monique vs. Melody (bedroom race)** | 1 | 3 |
| **7 — Epilogue** | 0 | 0 |
| **Total** | 3 | 8 |
