...
| **Garret** (Nurse flashback) | **Popped** — Amy bite. | **Popped** — Amy squeeze/snap. | — |
| **Unnamed bathroom freshman** | **Healthy** — Michelle leaves one nut. | **Popped** — Michelle kick POP (Cheerleader). | — |
| **John Transon, Ben, Max, Joel** | **Popped (offscreen)** — Joan's prior swim-team castrations referenced. | **Popped (offscreen)** | — |
...
| **3 — The Goth** | 2 | 1 |
| **4 — The Scientist** | 2 | 2 |
| **5 — The Cheerleader** | 1 | 0 |
| **6 — The Target** | 1 | 1 |
| **7 — The Nurse** | 2 | 1 |
| **8 — The Victim** | 1 | 0 |
| **9 — The Businesswoman** | 1 | 1 |
| **10 — The Half-Man** | 0 | 0 |
| **11 — The Doctor** | 1 | 4 |
| **12 — Epilogue** | 3 | 1 |
| **Total** | 15 | 13 |
