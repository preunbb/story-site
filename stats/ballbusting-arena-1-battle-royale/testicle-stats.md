# The Ballbusting Arena 1: Battle Royale — testicle stats

## Male testicle status

| Male character | Left testicle | Right testicle |
| --- | --- | --- |
| **Dan** | **Popped** — Sofia isolates and ruptures left with knee early in match. | **Popped** — Britt foot-stomps last nut after Dan's revenge knee. |
| **Venn** (blonde virgin) | **Popped** — Sofia squeeze/twist after first pop. | **Popped** — Sofia first knee pop (left per close-up), then finish. |
