...
/** Shared Ko-fi / Amazon links for story #49 preview + password-gated full. */
...
window.DATA_ANDREA_LUCAS_FULL = {
  ...
  passwordGateDomain: "story-site:andrea-lucas:gate:",
  passwordKeyDomain: "story-site:andrea-lucas:key:",
  passwordHint:
    "The password is the first word of chapter 7 followed by the first word of chapter 23. All lowercase, no spaces or punctuation.",
...
/**
 * Password-gated full Bereavement Counseling manuscript. Opened via
 * "View full story (password)" / "Read full story" on story #49
 * (#story/bereavement-full/read). Plaintext lives only in dist/ (gitignored)
 * and the encrypted asset below.
 */
...
window.DATA_STORIES = [
  ...
  },
  {
    ...
    summary:
      "Nikita is an intern and personal assistant to her married boss, Mr. Wester. She has some very unusual fantasies. He accidentally discovers the erotica she reads.",
  ...
  },
  {
    ...
    subtitle:
      "Poiu is the original author of the first 12 chapters of this story, from here. While I’m not a furry myself, I appreciate his (and KiwiBB’s) red dragon world. Someone commissioned me to make an alternative to chapter 13, as well as two endings. Cover image by Achromasluth",
